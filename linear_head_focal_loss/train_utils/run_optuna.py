...
from linear_head_focal_loss.main import load_hyperparams
from linear_head_focal_loss.train_test_elements import get_modules
...
def _run_single_stage_pipeline(
    ...
    """단일 Stage 학습을 수행하고 best MCC를 반환합니다."""
...
def _create_objective(
    ...
    def objective(trial: optuna.Trial) -> float:
        ...
        best_mcc = _run_single_stage_pipeline(
...
def run_hpo(n_trials: int = N_TRIALS) -> None:
    ...
    study = optuna.create_study(
        study_name="dinov3_focal_loss_hpo",
        direction="maximize",
    ...
    print(f"Best Trial Score (Val MCC): {study.best_value:.4f}")
