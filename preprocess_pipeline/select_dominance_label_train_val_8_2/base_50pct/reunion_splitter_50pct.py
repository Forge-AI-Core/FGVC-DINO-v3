...
BASE_TRAIN_FOLDERS = CLS_DATA_DIR / "base_split_folders_50pct/train"
BASE_VAL_FOLDERS = CLS_DATA_DIR / "base_split_folders_50pct/val"

ANNOTATION_PATH = CLS_DATA_DIR / "corrected_crop_annotations_50pct.json"

VANILLA_TRAIN_DIR = CLS_DATA_DIR / "vanilla/split_dataset_50pct/train"
VANILLA_VAL_DIR = CLS_DATA_DIR / "vanilla/split_dataset_50pct/val"
...
def main() -> None:
    print(f"Vanilla Train/Val 올바른 분할 진행 중 (50pct)...")
