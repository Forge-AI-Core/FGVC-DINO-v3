...
# 크롭 데이터 어노테이션 경로
CROPPED_ANNOTATION_PATH = CLS_DATA_DIR / "crop_annotations_50pct.json"
...
# 클러스터링 파일 보관소 디렉토리
CLUSTERED_GROUPS_DIR = CLS_DATA_DIR / "clustered_groups_50pct"
...
def compute_crop_box(
    ...
    # 양쪽으로 총 50% 마진을 주기 위해 각 방향으로 25%(0.25)씩 마진을 계산합니다.
    pad_w = w * 0.25
    pad_h = h * 0.25
