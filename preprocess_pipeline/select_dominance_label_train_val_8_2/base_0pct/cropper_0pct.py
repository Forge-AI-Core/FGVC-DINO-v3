...
# 크롭 데이터 어노테이션 경로
CROPPED_ANNOTATION_PATH = CLS_DATA_DIR / "crop_annotations_0pct.json"
...
# 클러스터링 파일 보관소 디렉토리
CLUSTERED_GROUPS_DIR = CLS_DATA_DIR / "clustered_groups_0pct"
...
def compute_crop_box(
    ...
    # 양쪽으로 총 0% 마진을 주기 위해 각 방향으로 0% 마진을 계산합니다.
    pad_w = 0.0
    pad_h = 0.0
