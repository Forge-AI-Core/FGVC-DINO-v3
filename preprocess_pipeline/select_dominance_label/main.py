...
4. Folder Split
5. Testset Sampler
6. Train/Val Sampler (Unique)
7. Reunion Splitter (Vanilla)
"""
...
try:
    ...
    from base_25pct import testset_sampler_25pct
    from base_25pct import train_val_sampler_25pct
    from base_25pct import reunion_splitter_25pct

    # 10% Pipeline
    from base_10pct import cropper_10pct
    from base_10pct import label_synchronizer as label_synchronizer_10
    from base_10pct import cluster_10pct
    from base_10pct import folder_splitter_10pct
    from base_10pct import testset_sampler_10pct
    from base_10pct import train_val_sampler_10pct
    from base_10pct import reunion_splitter_10pct
    ...
    from base_0pct import testset_sampler_0pct
...
def run_pipeline() -> None:
    print("=" * 70)
    print(" 🚀 Starting Preprocessing Pipeline Orchestration (25% -> 10% -> 0%) ")
    print("=" * 70)
    ...
    print("\n" + "=" * 50)
    print(" [25%] Step 4: Folder Split (8:1:1) ")
    print("=" * 50)
    folder_splitter_25pct.main()

    print("\n" + "=" * 50)
    print(" [25%] Step 5: Testset Sampler ")
    print("=" * 50)
    testset_sampler_25pct.main()

    print("\n" + "=" * 50)
    print(" [25%] Step 6: Train/Val Sampler (Unique) ")
    print("=" * 50)
    train_val_sampler_25pct.main()

    print("\n" + "=" * 50)
    print(" [25%] Step 7: Reunion Splitter (Vanilla) ")
    print("=" * 50)
    reunion_splitter_25pct.main()

    # ------------------ 10% Pipeline ------------------
    print("\n" + "#" * 60)
    print(" 🌟 RUNNING 10% PADDING PIPELINE 🌟 ")
    print("#" * 60)
    
    print("\n" + "=" * 50)
    print(" [10%] Step 1: Cropping ")
    print("=" * 50)
    cropper_10pct.main()

    print("\n" + "=" * 50)
    print(" [10%] Step 2: Label Synchronization (Cascade Consensus) ")
    print("=" * 50)
    label_synchronizer_10.main()

    print("\n" + "=" * 50)
    print(" [10%] Step 3: Clustering ")
    print("=" * 50)
    cluster_10pct.main()

    print("\n" + "=" * 50)
    print(" [10%] Step 4: Folder Split (8:1:1) ")
    print("=" * 50)
    folder_splitter_10pct.main()

    print("\n" + "=" * 50)
    print(" [10%] Step 5: Testset Sampler ")
    print("=" * 50)
    testset_sampler_10pct.main()

    print("\n" + "=" * 50)
    print(" [10%] Step 6: Train/Val Sampler (Unique) ")
    print("=" * 50)
    train_val_sampler_10pct.main()

    print("\n" + "=" * 50)
    print(" [10%] Step 7: Reunion Splitter (Vanilla) ")
    print("=" * 50)
    reunion_splitter_10pct.main()
    ...
    print("\n" + "=" * 50)
    print(" [0%] Step 4: Folder Split (8:1:1) ")
    print("=" * 50)
    folder_splitter_0pct.main()

    print("\n" + "=" * 50)
    print(" [0%] Step 5: Testset Sampler ")
    print("=" * 50)
    testset_sampler_0pct.main()

    print("\n" + "=" * 50)
    print(" [0%] Step 6: Train/Val Sampler (Unique) ")
    print("=" * 50)
    train_val_sampler_0pct.main()

    print("\n" + "=" * 50)
    print(" [0%] Step 7: Reunion Splitter (Vanilla) ")
    print("=" * 50)
