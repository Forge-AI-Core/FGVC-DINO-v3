...
# 크롭 데이터 어노테이션 경로
CROPPED_ANNOTATION_PATH = CLS_DATA_DIR / "corrected_crop_annotations_0pct.json"


# 임베딩 파일 정보 보관소 디렉토리
EMBEDDING_FILE_DIR = CLS_DATA_DIR / "embeddings"
# 임베딩 파일
EMBEDDING_FILE_PATH = EMBEDDING_FILE_DIR / "embeddings_0pct.npy"
# 이미지 경로 파일
IMAGEPATH_FILE_PATH = EMBEDDING_FILE_DIR / "image_paths_0pct.txt"
