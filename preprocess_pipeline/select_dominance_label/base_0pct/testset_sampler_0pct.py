...
TEST_FOLDERS_DIR = CLS_DATA_DIR / "base_split_folders_0pct/test"
ANNOTATION_PATH = CLS_DATA_DIR / "corrected_crop_annotations_0pct.json"

UNIQUE_TEST_DIR = CLS_DATA_DIR / "unique_sampling/split_dataset_0pct/test"
VANILLA_TEST_DIR = CLS_DATA_DIR / "vanilla/split_dataset_0pct/test"
