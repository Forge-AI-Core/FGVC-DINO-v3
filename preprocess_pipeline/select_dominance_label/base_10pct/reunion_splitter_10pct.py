...
BASE_TRAIN_FOLDERS = CLS_DATA_DIR / "base_split_folders_10pct/train"
BASE_VAL_FOLDERS = CLS_DATA_DIR / "base_split_folders_10pct/val"

ANNOTATION_PATH = CLS_DATA_DIR / "corrected_crop_annotations_10pct.json"

VANILLA_TRAIN_DIR = CLS_DATA_DIR / "vanilla/split_dataset_10pct/train"
VANILLA_VAL_DIR = CLS_DATA_DIR / "vanilla/split_dataset_10pct/val"
...
def main() -> None:
    ...
    # 원래 8:1:1이었으므로, Train과 Val의 상대 비율은 8:1 입니다.
    # 즉 Train은 8/9, Val은 1/9 입니다.
    train_ratio = 8.0 / 9.0
